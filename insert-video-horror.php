...
// up img
// สร้างตัวแปรมารับ
$video = $entry['video_horror'];
$videoimg = $entry['horror_img'];
...
try{
    ...
    $videoimgNothavePrefix = substr($videoimg, 5);
    $splited = explode(",", $videoimgNothavePrefix);
    $mimeType = $splited[0];
    $imageData = $splited[1];
...
VALUES (
 '" . $entry['horror_name'] . "',
 '" . $entry['horror_category'] . "',
 '" . $entry['horror_details'] . "',
 '" . $entry['actor'] . "',
 '" . $entry['director'] . "',
 '" . $videoUrl . "',
 '" . $imageUrl . "')
